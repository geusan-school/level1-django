    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('amount', models.PositiveBigIntegerField(verbose_name='amount of payment')),
                ('buyer', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='buyer of payment')),
            ],
        ),
        migrations.CreateModel(
            name='PaymentItem',
